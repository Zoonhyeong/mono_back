...
from .views import Registration, Login, MemberListAPI, MemberAPI, SubscribeListAPI,SubscribeSidAPI, SubGroupListAPI, SubGroupSidAPI, SubscribeListAndGroupAPI, SubscribeCancelAPI
